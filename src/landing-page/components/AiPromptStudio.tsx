    ...
    <section className="py-16 sm:py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400 text-xs sm:text-sm font-bold uppercase tracking-wider mb-3">
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-card border border-border shadow-xl overflow-hidden">
          
          {/* Prompt Chips Bar */}
          <div className="p-4 sm:p-6 bg-muted/40 border-b border-border/80">
            <span className="text-xs uppercase font-bold text-muted-foreground tracking-wider mb-3 block">
              ⚡ Click a Prompt to Test AI Generator:
            </span>
          ...
          <div className="p-6 sm:p-8">
            <div className="flex items-center justify-between gap-4 mb-4 pb-3 border-b border-border/60">
              ...
              <button
                onClick={handleCopy}
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-muted hover:bg-accent text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors"
              >
                {copied ? (
                  <>
            ...
            <div className="bg-muted/30 rounded-2xl p-4 sm:p-6 border border-border/50 font-sans text-xs sm:text-sm text-foreground/90 whitespace-pre-line leading-relaxed min-h-[160px]">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-border/60">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs sm:text-sm font-bold shadow-md transition-all hover:scale-105 whitespace-nowrap"
              >
